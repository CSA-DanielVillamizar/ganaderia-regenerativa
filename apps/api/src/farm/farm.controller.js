...
let FarmController = (() => {
    let _classDecorators = [ApiTags('Fincas'), Controller('farms'), UseGuards(JwtAuthGuard), ApiBearerAuth()];
    ...
    var FarmController = _classThis = class {
        constructor(farmService) {
            Object.defineProperty(this, "farmService", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: (__runInitializers(this, _instanceExtraInitializers), farmService)
            });
        }
        create(dto, req) {
    ...
    __setFunctionName(_classThis, "FarmController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _create_decorators = [Post(), ApiOperation({ summary: 'Crear nueva finca' })];
        _findAll_decorators = [Get(), ApiOperation({ summary: 'Listar mis fincas' })];
        _findOne_decorators = [Get(':id'), ApiOperation({ summary: 'Obtener finca por ID' })];
        _update_decorators = [Put(':id'), ApiOperation({ summary: 'Actualizar finca' })];
        _remove_decorators = [Delete(':id'), ApiOperation({ summary: 'Eliminar finca' })];
        ...
        FarmController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FarmController = _classThis;
})();
