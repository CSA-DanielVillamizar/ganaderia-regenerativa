...
let AuthController = (() => {
    ...
    (() => {
        ...
        _login_decorators = [Post('login'), ApiOperation({ summary: 'Login con email y contraseña' })];
        _getProfile_decorators = [Get('me'), UseGuards(JwtAuthGuard), ApiBearerAuth(), ApiOperation({ summary: 'Obtener perfil actual' })];
